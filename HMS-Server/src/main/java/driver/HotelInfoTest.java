...
public class HotelInfoTest {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(hotelinfoDataService.addHotelinfo(new HotelinfoPO("0200001","梓航大酒店", TradeArea.Xianlin, Address.Xianlin,
                "仙林大道","很好","服务周到","13596297777",5,9.9,200.0)));
        System.out.println(hotelinfoDataService.addHotelinfo(new HotelinfoPO("0200002","志豪大酒店", TradeArea.Xianlin, Address.Xianlin,
                "仙林小道","很好","服务周到","13236539018",4,8.0,150.0)));
        System.out.println(hotelinfoDataService.addHotelinfo(new HotelinfoPO("0200003","组长大酒店", TradeArea.Gulou, Address.Gulou,
                "鼓楼","很好","服务周到","13331411234",3,5.5,100.0)));
        System.out.println(hotelinfoDataService.addHotelinfo(new HotelinfoPO("0200004","喋喋大酒店", TradeArea.Gulou, Address.Gulou,
        ...
        System.out.println(hotelinfoDataService.setHotelinfo(new HotelinfoPO("0200001","梓航大酒店", TradeArea.Xianlin, Address.Xianlin,
