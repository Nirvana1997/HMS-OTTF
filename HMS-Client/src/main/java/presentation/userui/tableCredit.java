...
public class tableCredit {
    ...
    public int getChange() {return Change.get();}
    public SimpleIntegerProperty changeProperty() {return Change;}
    public void setChange(int change) {this.Change.set(change);}

    public int getResult() {return Result.get();}
    public SimpleIntegerProperty resultProperty() {return Result;}
    public void setResult(int result) {this.Result.set(result);}
