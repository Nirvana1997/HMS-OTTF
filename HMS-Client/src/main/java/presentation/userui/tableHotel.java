...
public class tableHotel {
    ...
    public void setHasNormal(String hasNormal) {
        this.HasNormal.set(hasNormal);
    }

    public void setHasAbnormal(String hasAbnormal) {
        this.HasAbnormal.set(hasAbnormal);
    }

    public void setHasCanceled(String hasCanceled) {
        this.HasCanceled.set(hasCanceled);
    }
    ...
    public SimpleIntegerProperty starProperty() {
        return Star;
    }
    ...
    public String getHasNormal() {
        return HasNormal.get();
    }

    public SimpleStringProperty hasNormalProperty() {
        return HasNormal;
    }
    ...
    public SimpleStringProperty hasAbnormalProperty() {
        return HasAbnormal;
    }

    public String getHasCanceled() {
        return HasCanceled.get();
    }

    public SimpleStringProperty hasCanceledProperty() {
        return HasCanceled;
    }
}
