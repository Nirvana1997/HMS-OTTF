...
public class OrderDataImpl_stub implements OrderDataService {
    ...
    OrderPO order1 = new OrderPO("020000000001", "ZHotel", TradeArea.Xianlin, Address.NJU, "In Xianlin", 1, 1, "2016_5_8", "2016_5_9", RoomType.SingleRoom, false, "001", "151520175", OrderState.executing, 300, "Web period", "001");
    OrderPO order2 = new OrderPO("020000000002", "XHotel", TradeArea.XuanQuan, Address.NJU, "In XuanQuan", 1, 2, "2016_9_10", "2016_9_12", RoomType.StandardRoom, false, "002", "151520119", OrderState.abnormal, 200, "Web Vip", "001");
    ...
    OrderPO order4 = new OrderPO("020000000001", "BHotel", TradeArea.Xianlin, Address.NJU, "In Xianlin", 3, 2, "2016_1_1", "2016_1_2", RoomType.DoubleRoom, false, "004", "151520135", OrderState.executing, 130, "Trade discount", "001");
