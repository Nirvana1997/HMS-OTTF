...
public class HotelinfoDataImpl_stub implements HotelinfoDataService {
    ...
    HotelinfoPO hotel1 = new HotelinfoPO("0001", "仙林大酒店", TradeArea.Xianlin, Address.NJU,  null, null, "VergGood", "GreatService", 3, 3);
    HotelinfoPO hotel2 = new HotelinfoPO("0002", "喋喋大酒店", TradeArea.Xianlin, Address.NJU, null, null, "VergGood", "GreatService", 4, 5);
    HotelinfoPO hotel3 = new HotelinfoPO("0003", "萱萱大酒店", TradeArea.XuanQuan, Address.XuanXuan, null, null, "VergGood", "GreatService", 5, 5);
